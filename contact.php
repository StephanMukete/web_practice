...
if (array_key_exists('send', $_POST)) {
  ...
  if (!$suspect && empty($missing)) {
	...
	$message .= "How did you Know Stephan: $howhear\n\n";
...
<title>Stephan's Website<?php if (isset($title)) {echo "&#8212;{$title}";} ?></title>
...
<div id="wrapper">
    ...
    <div id="maincontent">
		...
		<?php } ?>
        <p> I know you all are so much interested in Stephan's Life that you just can't resist visiting his website over and over again. For this reason, I thought it wise to provide a page to enable you contact me as often as you wish. Wish you the best as you go through my contact page .</p>
        <form id="feedback" method="post" action="">
			...
			<p>
				...
				<?php } ?>
				/>
				<label for="anime">Intelligence/Determination</label>
			</p>
			<p>
			...
			<p>
				...
				<?php } ?>
				/>
				<label for="judo">Singing, Discussing, etc</label>
			</p>
			</div>
			<div>
			<p>
			...
			<p>
				...
				<?php } ?>
				/>
				<label for="scitech">Nice &amp; fun to be with</label>
			</p>
			<p>
				...
				<?php } ?>
				/>
				<label for="travel">His Handsomeness</label>
			</p>
			</div>
			</fieldset>
            <p>
				<label for="select">How did you get in contact with Stephan?</label>
				<select name="howhear" id="howhear">
					...
					selected="selected"
					<?php } ?>
					>went to the same school together</option>
					<option value="went to the same school together"
					<?php
					if (isset($missing) && $_POST['howhear'] == 'recommended by friend') { ?>
					selected="selected"
					<?php } ?>
					>Through a friend</option>
			...
			<p>
				<label for="select">What characteristics do you associate with Stephan?</label>
